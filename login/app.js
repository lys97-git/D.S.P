...
function mapErrorMessage(error) {
  ...
  if (msg.includes("duplicate key value") && msg.includes("user_profiles_login_id_key")) {
    return "이미 사용 중인 로그인 ID입니다.";
  }
  if (msg.includes("duplicate key value") && msg.includes("user_profiles_phone_key")) {
    return "이미 등록된 전화번호입니다.";
  }
  if (msg.includes("duplicate key value") && msg.includes("user_profiles_email_key")) {
